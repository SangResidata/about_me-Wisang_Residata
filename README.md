...
|--------|-------------|-------|
| SupplyChain_ETL | Full ETL pipeline extracting, cleaning and loading Supply Chain data into a relational SQL Server database | SQL Server, T-SQL, BULK INSERT |
